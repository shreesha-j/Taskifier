...
/**
 * TaskModal component for displaying and editing a task.
...
const TaskModal = props => {
   ...
   * @param {Event} e - The event triggered by changing the title input.
   */
   ...
   * @param {Event} event - The event triggered by changing the editor content.
